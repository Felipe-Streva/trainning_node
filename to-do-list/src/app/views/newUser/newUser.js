    ...
    <body>
        ...
        <div class="d-flex justify-content-center">
            <div class="w-50 p-4 border rounded shadow-sm"> 
                <form class="flex-fill" id="formLogin" method="POST" action="/insertNewUser">
                    ...
                    <button type="submit" class="btn btn-secondary btn-sm">Create Account</button>
                </form>
            </div>
            
        </div>
        <div style="width:100%; display:flex; flex-direction:column; align-items:center;">
            <a href="/"><button class="btn btn-secondary btn-sm mt-5" style="width:100px;">Return to Login</button></a>
        </div>
